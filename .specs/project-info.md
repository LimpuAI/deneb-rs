...
| deneb-wit | WASI 集成层、WIT 类型转换、lib_mode | 1037 | 20 |
| deneb-wit-wasm | WASI Component Model 导出（wit-bindgen 0.51） | 160 | — |
| deneb-demo | 桌面演示（tiny-skia + wasmtime host） | 1576 | 13 |
...
| wit-bindgen | 0.51 | WIT 绑定生成 | wit-wasm |
...
### WASI 集成
- WIT 接口：data-parser + chart-renderer
- 库调用模式（宿主嵌入）
